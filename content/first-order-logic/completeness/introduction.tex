...
true.
But the completeness theorem does not rule out the existence of other \iftag{FOL}{!!{structure}s}{!!{valuation}s} that make the same axioms true.
\iftag{FOL}{Ultimately, whether Hilbert was correct depends on how different models of a set of axioms are related, a topic we return to in the next chapter.}{}
